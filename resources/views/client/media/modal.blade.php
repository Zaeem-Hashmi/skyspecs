    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header justify-content-center border-0">
            <div>
                <img src="{{ asset("client/assets/logo.png") }}" alt="" width="80px;" class="d-block mx-auto">
                <h2 class="modal-title text-center fw-bold mt-3" id="exampleModalLabel" style="line-height: 20px">MEDIA</h2>
            </div>
            <button type="button" class="btn-close rounded-circle" data-bs-dismiss="modal" aria-label="Close" style="position: absolute;top:20px;right:20px"></button>
        </div>
        <div class="modal-body bg-cream">
            ...
            <div class="owl-carousel owl-theme px-3 mt-3">
                <div class="bg-light p-3" style="height: 450px;">
                    ...
                    <p class="fw-bold text-center text-uppercase" style="font-size: 13px">
        ...
        <div class="modal-body bg-light">
            <h3 class="modal-title px-3" id="exampleModalLabel" style="line-height: 20px;font-weight:900;">LATEST
                <hr style="height: 3px;background-color:#000;opacity:1;" class="mb-5">
            </h3>
        </div>
        ...
        <div class="modal-body bg-cream">
            <h3 class="modal-title text-center mt-3 mt-3 bg-light-cream mx-auto px-3 py-3" id="exampleModalLabel" style="line-height: 20px;width:320px;min-width:280px;font-weight:900;">TRENDING TOPICS</h3>
            <div class="owl-carousel owl-theme px-3 mt-3">
                <div class="bg-light p-3" style="height: 450px;">
                    ...
                    <p class="" style="font-size: 12px;text-align:center;">
                        The music industry has undergone a seismic shift in the past decade, with the rise of streaming platforms like Spotify, Apple Music, and Tidal revolutionizing the way people consume music. These services have made it easier than ever for listeners
                    </p>
                </div>
                <div class="bg-light p-3" style="height: 450px;">
                    ...
                    <p class="" style="font-size: 12px;text-align:center;">
                        Diversity and representation in media have become increasingly important topics in recent years, as audiences demand content that reflects the world’s rich tapestry of cultures, identities, and experiences. Historically, media has often been dominated by a narrow set of voices and perspectives,
                    </p>
                </div>
                <div class="bg-light p-3" style="height: 450px;">
                    ...
                    <p class="" style="font-size: 12px;text-align:center;">
                        the advent of artificial intelligence (AI) in music production has sparked a revolution in the industry, and hip-hop is no exception. AI-generated music, where algorithms compose beats, lyrics, and even entire songs, is becoming increasingly prevalent.
                    </p>
                </div>
                <div class="bg-light p-3" style="height: 450px;">
                    ...
                    <p class="" style="font-size: 12px;text-align:center;">
                        Social media has transformed the way we experience music and culture, creating new opportunities for artists to connect with fans and for listeners to discover new music. Platforms like Instagram, TikTok, and Twitter have become essential tools for musicians to promote their work, build their brand.
                    </p>
                </div>
                <div class="bg-light p-3" style="height: 450px;">
                    ...
                    <p class="" style="font-size: 12px;text-align:center;">
                        Sean "Diddy" Combs, one of the most influential figures in hip-hop, has recently been embroiled in a series of lawsuits and controversies that have cast a shadow over his legacy. Diddy, known for his role in shaping the careers of artists like The Notorious B.I.G., Mary J. Blige.
                    </p>
                </div>
                <div class="bg-light p-3" style="height: 450px;">
                    ...
                    <p class="" style="font-size: 12px;text-align:center;">
                        Rap battles have long been a cornerstone of hip-hop culture, serving as a platform for artists to showcase their lyrical prowess and assert their dominance in the genre. Traditionally held in parks, clubs, and on street corners, rap battles have evolved significantly over the years,
                    </p>
                </div>
                <div class="bg-light p-3" style="height: 450px;">
                ...
                <div class="bg-light p-3" style="height: 450px;">
                    ...
                    <p class="" style="font-size: 12px;text-align:center;">
                        Women in sports media have come a long way, breaking barriers and challenging the stereotypes that have long defined the industry. From commentators and analysts to journalists and broadcasters, women are making their mark in a field that was once dominated by men.
                    </p>
                </div>
                <div class="bg-light p-3" style="height: 450px;">
                    ...
                    <p class="" style="font-size: 12px;text-align:center;">
                        Esports has exploded onto the global stage, transforming from a niche hobby into a multi-billion-dollar industry. Competitive gaming now draws millions of viewers, with tournaments for games like League of Legends, Dota 2, and Fortnite rivaling traditional sports events .
                    </p>
                </div>
            </div>
        </div>
