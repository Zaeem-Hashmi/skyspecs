          ...
          <div class="modal-content">
              <div class="modal-header justify-content-center border-0">
                  <div>
                      ...
                      <h2 class="modal-title text-center fw-bold mt-3" id="exampleModalLabel" style="line-height: 20px">BLOGS AND NEWS</h2>
                  </div>
              ...
              <div class="modal-body bg-cream">
                  ...
                  <div class="owl-carousel owl-theme px-3 mt-3">
                      <div class="bg-light p-3">
                          ...
                          <a target="" href="/blog/#filmmaking" class="d-block fw-bold text-center text-uppercase text-dark my-4" style="font-size: 13px">
